...
\color{red}
Scala Collections exposes many operations \\
 - optimized data structures to speed operations

Vectors \\
 - good (well optimized on radix based tree structure) for many situations \\
 - not good for paralellization due to concat overhead

RRB Trees \\
 - additionally good for concatenation and insets \\
 - improves paralellization due to concat \\
 - radix based optimizations from Vector do not apply directly.
\color{black}
}
