...
\color{red} TODO: Explain operation (once, ) \color{black}

% Explain append/prepend
\color{red} TODO: Append/Prepend \color{black}

% Explain the apply operations
\color{red} TODO: Apply \color{black}

% If more performance is requires it is possible to write transient state operations directly to transient state
\color{red} TODO: Direct form transient ops \color{black}
